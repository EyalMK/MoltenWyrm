...
// THIS FILE IS DEPRECATED
	...
	#define FILEVERSION         "Beta 0.1.0"
		...
		# ifdef _WIN64
			#  define _FULLVERSION _PACKAGENAME " " VER_FILEVERSION_STR " (Win64)"
			#  define BUILD_PLATFORM "Win64"
		# else
			#  define _FULLVERSION _PACKAGENAME " " VER_FILEVERSION_STR " (Win32)"
			#  define BUILD_PLATFORM "Win32"
		# endif
	#else
		#  define _FULLVERSION _PACKAGENAME " " VER_FILEVERSION_STR " (Unix)"
