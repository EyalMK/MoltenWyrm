...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_SKILL_CHANCE_ARCHAEOLOGY_STEPS]  = sConfigMgr->GetIntDefault("SkillChance.ArchaeologySteps", 75);
    ...
    m_int_configs[CONFIG_RBG_CONQUEST_POINTS_REWARD] = sConfigMgr->GetIntDefault("Battleground.RatedConquestPointsReward", 400);

    // Arena
    m_int_configs[CONFIG_ARENA_CONQUEST_POINTS_REWARD] = sConfigMgr->GetIntDefault("Arena.ConquestPointsReward", 135);
    ...
    m_bool_configs[CONFIG_IS_TOURNAMENT_REALM] = sConfigMgr->GetIntDefault("RealmServerInfo.IsTournament", false);
    m_bool_configs[CONFIG_IS_TRIAL_ACCOUNTS] = sConfigMgr->GetIntDefault("RealmServerInfo.TrialAccountsEnabled",true);
...
void World::SetInitialWorldSettings()
{
    ...
    LoginDatabase.PExecute("INSERT INTO uptime (realmid, starttime, uptime, revision) VALUES(%u, %u, 0, '%s')", realmID, uint32(m_startTime), _FULLVERSION);       // One-time query
