...
public:
    ...
    InstanceScript * GetInstanceData(Map* map);
    ...
    void OnUpdateZone(Player* pPlayer, uint32 newZone, uint32 newArea, uint32 oldZone, uint32 oldArea);
    void OnMapChanged(Player* pPlayer);
    void OnRequestLFG(Player* pPlayer);
